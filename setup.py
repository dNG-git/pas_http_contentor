...
#
	parameters = { "install_data_plain_copy_extensions": "json,tsc",
	               "pasHttpContentorVersion": get_version()
	             }
	...
	setup(name = "pas_http_contentor",
	      version = get_version(),
	      description = "Python Application Services",
	      long_description = """"pas_http_contentor" adds XHTML rendered support for "pas_contentor" documents.""",
	      author = "direct Netware Group et al.",
	      author_email = "web@direct-netware.de",
	      license = "GPLv2+",
	      url = "https://www.direct-netware.de/redirect?pas;http;contentor",
